...
// Generic email send, reusing the exact same Resend account already
// configured for OTP emails (lib/email-otp.js) — no new email provider or
// architecture introduced. `bcc` (not `to`) is used for broadcasts so
