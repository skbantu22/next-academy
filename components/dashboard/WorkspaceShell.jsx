            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden text-left sm:block">
                  ...
                  <small className="text-[10px] text-muted">{profileRoleLabel}</small>
                </span>
                <span className="text-subtle">⌄</span>
              </button>
              {profileOpen && (
                <div className="absolute right-0 top-12 z-30 w-52 rounded-2xl border border-border-subtle bg-white p-3 shadow-2xl">
                  <p className="border-b border-border-subtle pb-3 text-xs font-semibold text-ink">
                    {userEmail}
                  </p>
                  <p className="py-3 text-xs text-muted">{profileDescription}</p>
                  <button
                    onClick={onLogout}
