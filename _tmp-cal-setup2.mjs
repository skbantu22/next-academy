...
const EMAILS = ["cal.dir@example.com", "cal.stu@example.com", "cal.teach@example.com"];
if (mode === "down") {
...
const teachUid = await user("cal.teach@example.com", "Teacher", { displayName: "Cal Teacher" });
// a DRAFT event organized by this teacher — should be visible ONLY to them (and Director), never to the student
await db.collection("academyEvents").doc("cal-teacher-draft").set({
  name: "Teacher Draft Workshop", type: "Workshop", eventDate: "2026-12-01", startTime: "09:00", endTime: "11:00",
  location: "Room 4", organizer: "Cal Teacher", organizerId: teachUid, published: false, status: "", participantCount: 0,
}, { merge: true });
